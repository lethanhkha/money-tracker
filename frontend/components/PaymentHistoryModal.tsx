...
export default function PaymentHistoryModal({
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Xóa khoản góp thành công");
      setDeleteId(null);
    },
    onError: () => {
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">{debtTitle}</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">Chưa có lịch sử góp nợ</p>
            </div>
          ) : (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full animate-slide-up">
            ...
            <p className="text-gray-600 mb-6">
              Bạn có chắc chắn muốn xóa khoản góp này? Số dư nợ còn lại sẽ được
              tính toán lại.
            </p>
